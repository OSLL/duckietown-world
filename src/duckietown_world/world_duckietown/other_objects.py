...
class Sign(PlacedObject):
    ...
    def draw_svg(self, drawing, g):
        ...
        c = drawing.rect(
            insert=(-BASE_SIGN / 2, -BASE_SIGN / 2),
            fill="lightgreen",
            stroke_width=0.001,
            stroke="black",
        ...
        alpha = 1.2
        c = drawing.rect(
            insert=(-WIDTH_SIGN / 2, -BASE_SIGN / 2 * alpha),
            fill="#FFCB9C",
            stroke_width=0.001,
            stroke="black",
        ...
        c = drawing.rect(
            insert=(+0.01 + -PAPER_THICK / 2, -PAPER_WIDTH / 2),
            fill="white",
            stroke_width=0.001,
            stroke="black",
...
class SignOneWayRight(Sign):
    pass


class SignOneWayLeft(Sign):
    pass


class SignDuckCrossing(Sign):
    pass


class SignYield(Sign):
    pass


class SignNoLeftTurn(Sign):
    pass


class SignNoRightTurn(Sign):
    pass


class SignDoNotEnter(Sign):
    pass


class SignParking(Sign):
    pass


class SignPedestrian(Sign):
    pass
